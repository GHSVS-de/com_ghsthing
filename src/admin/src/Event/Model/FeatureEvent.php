...
namespace GHSVS\Component\GhsThing\Administrator\Event\Model;
...
class FeatureEvent extends AbstractImmutableEvent
{
     ...
     * Im Plugin kann man setzen ein $event->setAbort('PLG_WORKFLOW_FEATURING_CHANGE_STATE_NOT_ALLOWED');
